-- hud_brackets.lua — minimalist cyberdeck HUD-corner theme.
--
-- Style 9 of the compact theme set. See nfo_format.lua's header comment for
...
return {
  ...
  format_tool_result = function(ctx)
    ...
    if ctx.is_error then
      return C.red .. "┃" .. C.reset .. " " .. C.red .. first .. C.reset .. suffix .. " " .. C.red .. "⌊FAIL⌋" .. C.reset
    end
    return C.cyan .. "│" .. C.reset .. " " .. C.dim .. first .. C.reset .. suffix .. " " .. C.cyan .. "⌊OK⌋" .. C.reset
  end,
}
