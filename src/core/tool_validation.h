...
// Applies TypeBox-style coercion (mirroring validation.ts::coerceWithJsonSchema)
// before structural validation. Mutates `arguments` in place.
// Thread-safe; compiled validators are cached by schema string.
class ToolValidator {
public:
